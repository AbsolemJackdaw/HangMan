...
public class HangManEntity {
    public static final EntityType<NooseEntity> NOOSE = Registry.register(BuiltInRegistries.ENTITY_TYPE, new ResourceLocation(HangManCommon.MODID, HangManCommon.noose),
    ...
    public static final EntityType<CameraPlayerOnNoose> CAMERA = Registry.register(BuiltInRegistries.ENTITY_TYPE, new ResourceLocation(HangManCommon.MODID, HangManCommon.camera),

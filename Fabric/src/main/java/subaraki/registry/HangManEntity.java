...
public class HangManEntity {
    public static final EntityType<NooseEntity> NOOSE = Registry.register(Registry.ENTITY_TYPE, new ResourceLocation(HangManCommon.MODID, "hang_dummy"),
    ...
    public static final EntityType<CameraPlayerOnNoose> CAMERA = Registry.register(Registry.ENTITY_TYPE, new ResourceLocation(HangManCommon.MODID, "camera"),

...
public class HangManEntity {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ForgeNooseEntity>> HANG_DUMMY = ENTITY_TYPES.register(HangManCommon.noose,
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<CameraPlayerOnNoose>> CAMERA = ENTITY_TYPES.register(HangManCommon.camera,
